...
export function canEditParking(permissions = portalState.authPermissions || []) {
    const p = permissions || [];
    return p.includes('vehicle_registry.edit') || p.includes('apartment_mgmt.edit');
}

export function canEditBaseSlots(permissions = portalState.authPermissions || []) {
