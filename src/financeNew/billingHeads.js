/** Finance-New clone (billingHeads.js) */
...
export const getChargeHeads = () =>
    (fnFinances().maintenanceChargeHeads || [])
...
export const refreshBulkInvoiceHeads = () => {
    ...
    if (!heads.length) {
        ...
        document.getElementById('fn-bulk-open-heads-inline')?.addEventListener('click', openChargeHeadsModal);
        return;
    }
...
bindFinanceNewWindow('closeChargeHeadsModal', closeChargeHeadsModal);
