...
const API_DESCRIPTIONS = {
  ...
  'dashboard-summary.js': 'Dashboard summary endpoint (via identity-rest)',
  ...
  'external-connections.js': 'Legacy external connections shim → integrations-rest',
  'external-proxy.js': 'External API proxy (via integrations-rest)',
  'finance-mutations.js': 'Finance write mutations',
  'oauth-microsoft.js': 'Microsoft OAuth flow (via integrations-rest)',
  'oauth-service.js': 'OAuth service helper (via integrations-rest)',
  'passbook-jobs.js': 'Legacy passbook jobs shim → integrations-rest',
  'passbook-parse.js': 'Legacy passbook parse shim → integrations-rest',
  ...
  'rbac-mongo.js': 'Mongo identity + RBAC (via identity-rest)',
