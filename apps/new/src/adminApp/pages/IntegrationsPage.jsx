        ...
        <Paper sx={{ p: 2.5, mb: 2 }}>
            ...
            <Stack spacing={2}>
                ...
                <TextField
                    ...
                    helperText="Leave blank to use this API server (recommended on communityhub.evolyx.in). For local tunnels, set the https origin (or full …/api/passbook-webhook) so Evolyx can reach your machine."
                />
