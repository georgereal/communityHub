...
import { wireUiModeToggle, remapRouteForMode, getUiMode, isNewUi } from '@new/uiMode.js';
import { restoreMpaNavPref, wireHoverSidebar, syncHamburgerToHoverNav, applyMpaNavCollapsed } from '@new/appShell/navPref.js';
