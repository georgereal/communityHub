...
import { getUiMode, isNewUi } from '@new/uiMode.js';
import { applyMpaNavCollapsed, isMpaNavCollapsedPref } from '@new/appShell/navPref.js';
...
export const pageIsVisible = (page, permSet, _offline = false, navModuleId = null) => {
    ...
    if (page.route === 'admin-access' || page.route === 'an-roles') {
